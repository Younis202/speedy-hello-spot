...
export const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-background bg-gradient-mesh">
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex fixed inset-y-0 right-0 w-72 flex-col glass-dark border-l border-border/30">
        {/* Logo */}
      ...
      {/* Mobile Header */}
      <header className="lg:hidden fixed top-0 inset-x-0 z-50 glass-dark border-b border-border/20">
      ...
      {/* Main Content */}
      <main className="lg:mr-72 pt-16 lg:pt-0 pb-24 lg:pb-0 min-h-screen">
